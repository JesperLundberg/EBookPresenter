...
public class EBookRepositoryTests
{
    ...
    {
        var ebookRepository = new EBookRepository(new FileSystemFake(),
            new FileInfoFactoryFake());
    ...
    public void EBookRepository_OrderBooks_Alphabetic_Returns_Books_Ordered_By_Alphabetic_Order_Ascending()
    {
        ...
        var result = ebookRepository.OrderBooks(unorderedBookList,
            "alphabetic");
